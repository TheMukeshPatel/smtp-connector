...
function smtp_connector_for_wp_settings_register() {
    ...
    register_setting('smtp-connector-for-wp-settings-group', 'smtp_connector_for_wp_password', 'smtp_connector_for_wp_sanitize_option');
...
<h2>SMTP Connector Settings</h2>
  <p>Enter your SMTP details below. Check <a target="_blank" href="https://mpateldigital.com/smtp-connector/">this tutorial</a> to know more about configuration</p>
   <div id="poststuff">
    ...
    <table class="form-table">
        ...
        <td><input type="text" name="smtp_connector_for_wp_host" value="<?php echo esc_attr(get_option('smtp_connector_for_wp_host')); ?>" /></td>
        </tr>

        <tr valign="top">
        <th scope="row">From Name</th>
        <td><input type="text" placeholder="Enter Website Name" name="smtp_connector_for_wp_from_name" value="<?php echo esc_attr(get_option('smtp_connector_for_wp_from_name')); ?>" /></td>
        </tr>
         
        <tr valign="top">
        <th scope="row">SMTP Username</th>
        <td><input type="text" name="smtp_connector_for_wp_username" value="<?php echo esc_attr(get_option('smtp_connector_for_wp_username')); ?>" /></td>
        </tr>
        
        <tr valign="top">
        <th scope="row">SMTP Password</th>
        <td><input type="password" name="smtp_connector_for_wp_password" value="<?php echo esc_attr(get_option('smtp_connector_for_wp_password')); ?>" /></td>
        </tr>
        ...
        <td><input type="number" placeholder="587 Most in Cases like Gmail" name="smtp_connector_for_wp_port" value="<?php echo esc_attr(get_option('smtp_connector_for_wp_port')); ?>" />
